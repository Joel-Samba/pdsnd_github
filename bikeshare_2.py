...
def get_filters():
    ...
    city_name = ''
    while city_name.lower() not in cities_data:
        city_name = input("\nPlease Enter the name of the city whose data you want to explore,Choose between :chicago,new york city or washington\n")
        if city_name.lower() in cities_data:
            city = cities_data[city_name.lower()]
        else:
            print("Please ,kindly choose among the three provided cities.\n")

    # TO DO: get user input for month (all, january, february, ... , june)
    month_name = ''
    while month_name.lower() not in months_data:
        month_name = input("\nChoose the month you prefer to view :january,february,march,april,may,june or'all' : \n")
    ...
    while day_name.lower() not in days_data:
        day_name = input("\nkindly Choose one of the day of the week or all :\n")
